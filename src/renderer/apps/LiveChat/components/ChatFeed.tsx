...
const ChatFeed: React.FC<ChatFeedProps> = ({ events }) => {
    ...
    return (
        <div className="flex-grow bg-slate-800/30 rounded-xl overflow-hidden flex flex-col border border-white/5 backdrop-blur-sm">
            <div className="p-4 border-b border-slate-700/50 bg-slate-900/50 flex justify-between items-center">
                ...
                <span className="text-[10px] text-slate-600 bg-slate-800 px-2 py-0.5 rounded uppercase font-mono">Realtime</span>
            </div>
            <div 
                ref={feedRef}
